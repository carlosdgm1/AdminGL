    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('crear-notificacion') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Residnete <span class="text-danger">*</span></label>
                        <input value="{{ $residentes->nombre }}" required readonly name="" type="text" class="form-control"
                            onkeyup="javascript:this.value=this.value.toUpperCase();">
                            <input type="hidden" value="{{ $residentes->id }}" name="idr">
                    </div>
